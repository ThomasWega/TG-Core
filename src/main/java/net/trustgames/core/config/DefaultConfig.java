...
public class DefaultConfig {
    ...
    public static void create(@NotNull FileConfiguration defaultConfig) {
        ...
        // cooldowns
        defaultConfig.addDefault("cooldowns.command.max-per-second", 5d);
        defaultConfig.addDefault("cooldowns.warn-messages-limit-in-seconds", 0.5d);
        ...
        defaultConfig.addDefault("cooldowns.chat.same-limit-in-seconds.default", 120d);
        defaultConfig.addDefault("cooldowns.chat.same-limit-in-seconds.prime", 60d);
        defaultConfig.addDefault("cooldowns.chat.same-limit-in-seconds.knight", 45d);
        defaultConfig.addDefault("cooldowns.chat.same-limit-in-seconds.lord", 25d);
